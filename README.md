...
| | |
| :------ | :------ |
| **Identifies your library** | CRC32 of each ROM (headerless, and minus the iNES header on `.nes`) resolves the game against the [GameDB](https://sd2snes.ludufre.com/gamesdb). Handles SNES, Satellaview, Game Boy / Color / Super, NES and Master System. |
