...
export class ConfigDialog {
  ...
  protected readonly groups: SettingGroup[] = [
    ...
    { label: 'config.groups.files', fields: [text('SkinName'), text('MenuMusicFile'), text('MenuMusicFolder')] },
